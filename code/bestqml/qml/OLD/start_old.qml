...
//                console.log("Ilosc:",ilosc.currentIndex)
                if ( grupa.currentIndex < 0 || stany.currentIndex < 1 || ilosc.currentIndex < 1 || produkt.currentIndex < 0 ) {
                console.log("stany.currentIndex:",stany.currentIndex,"ilosc.currentIndex:",ilosc.currentIndex,"produkt.currentIndex",produkt.currentIndex )
                    tlo.visible = true
                    ddialog_e.open()
                    return
                }
                if ( grupa.currentIndex > -1  && ilosc.currentIndex > 0 && produkt.currentIndex > -1 && stany.currentIndex > 0 ){
...
//               anchors.fill: ddialog_calc
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "7"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "8"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "9"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "4"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "5"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "6"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "1"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "2"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "3"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
                      if (nilo.text.length < 4) {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "OK"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "0"
                  font.pixelSize: template.bSize
                  font.bold: true
                  onClicked: {
              ...
              Button { width: ddialog_calc.width/6; height: ddialog_calc.height/6; text:  "<-"
                  font.pixelSize: template.bSize
              onClicked: {
...
//                     contentItem: Text {
//                         leftPadding: 5
//                         rightPadding: styleBox.indicator.width + styleBox.spacing

//                         text: styleBox.displayText
//                         font: styleBox.font

//                         color: styleBox.pressed ? "red" : "blue"
//                         verticalAlignment: Text.AlignVCenter
//                         elide: Text.ElideRight
//                     }
...
//                         implicitWidth: 120
//                         implicitHeight: 40
//                         border.color: styleBox.pressed ? "red" : "black"
//                         border.width: styleBox.visualFocus ? 2 : 1
//                         radius: 2
//                     }
//                     popup: Popup {
//                         z: 210
